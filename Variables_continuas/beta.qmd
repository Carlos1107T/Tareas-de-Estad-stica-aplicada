...
cat("=== PARÁMETROS TEÓRICOS BETA(2,5) ===\n")
...
# 2. Gráfica de convergencia de la media
p_media <- ggplot(resultados, aes(x = n, y = media_muestral)) +
  geom_line(color = "blue", size = 1) +
  geom_hline(yintercept = media_teorica, color = "red", linetype = "dashed", lwd = 1) +
  labs(title = "Convergencia de la Media Muestral",
       subtitle = "Beta(2,5)",
       x = "Tamaño de Muestra",
       y = "Media Muestral",
       caption = paste("Línea roja: Media teórica =", round(media_teorica, 4))) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5))

# 3. Gráfica de convergencia de la varianza
p_varianza <- ggplot(resultados, aes(x = n, y = varianza_muestral)) +
  geom_line(color = "green", size = 1) +
  geom_hline(yintercept = varianza_teorica, color = "red", linetype = "dashed", lwd = 1) +
  labs(title = "Convergencia de la Varianza Muestral",
       subtitle = "Beta(2,5)",
       x = "Tamaño de Muestra",
       y = "Varianza Muestral",
       caption = paste("Línea roja: Varianza teórica =", round(varianza_teorica, 4))) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5))
...
p_histograma <- ggplot(data.frame(x = muestra_grande), aes(x = x)) +
  geom_histogram(aes(y = after_stat(density)), bins = 30,
                 fill = "lightblue", color = "black", alpha = 0.7) +
  stat_function(fun = dbeta, args = list(shape1 = alpha, shape2 = beta),
                color = "red", lwd = 1.2) +
  labs(title = "Distribución Beta(2,5) - Muestra n=10000",
       subtitle = "Histograma: datos simulados | Curva roja: PDF teórica",
       x = "Valores",
       y = "Densidad") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5),
...
for (n in size_muestra) {
  medias <- replicate(num_muestras, mean(rbeta(n, shape1 = alpha, shape2 = beta)))
...
ggplot(df_tcl, aes(x = medias)) +
  geom_histogram(aes(y = after_stat(density)), bins = 30,
                 fill = "lightblue", color = "black", alpha = 0.7) +
  geom_vline(xintercept = media_poblacional, color = "red", linetype = "dashed", size = 1) +
  geom_line(data = df_normal_teorica, aes(x = x, y = y),
            color = "red", size = 1.2, alpha = 0.8) +
  facet_wrap(~n_factor, scales = "free_y", ncol = 3) +
  labs(title = "Teorema Central del Límite - Distribución Beta(2,5)",
       subtitle = "Distribución de medias muestrales",
       x = "Media muestral",
       y = "Densidad",
       caption = paste("Línea roja: Media teórica =", round(media_poblacional, 4), 
